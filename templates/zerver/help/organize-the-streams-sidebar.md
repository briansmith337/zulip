...
Axxess tries to help by automatically pushes inactive streams to the bottom.

Axxess automatically moves inactive streams to the bottom
...
On Axxess, it is useful to organize streams in the sidebar in order to easily
...
## Pinning
Pinning a stream on Axxess pushes the stream to the top of your **Streams**
